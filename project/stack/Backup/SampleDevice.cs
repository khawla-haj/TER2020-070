...
namespace OpenSource.DeviceBuilder
{
	...
	class SampleDevice
	{
		...
		public SampleDevice()
		{
			...
			StructuralService.External_CreateBean = new OpenSource.DeviceBuilder.DvStructuralService.Delegate_CreateBean(StructuralService_CreateBean);
			...
			StructuralService.External_GetLinksFrom = new OpenSource.DeviceBuilder.DvStructuralService.Delegate_GetLinksFrom(StructuralService_GetLinksFrom);
